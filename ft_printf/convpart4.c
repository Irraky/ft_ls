...
/*   Updated: 2017/06/21 19:05:27 by drecours         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "libftprintf.h"

static void		convxplus(t_e *env, int i)
{
...
void			convx(va_list args, t_e *env)
{
	int		i;
...
void			convgx(va_list args, t_e *env)
{
	convx(args, env);
}

void			convp(va_list args, t_e *env)
{
	int		i;
